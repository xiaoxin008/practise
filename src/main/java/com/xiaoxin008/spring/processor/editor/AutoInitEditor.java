...
public class AutoInitEditor {
    ...
    static class DatePropertyEditorRegister implements PropertyEditorRegistrar{
      ...
      //xml配置文件
//    <bean id="dateFoo" class="com.xiaoxin008.spring.bean.common.DateFoo">
...
//    </bean>
//
//    <bean id="datePropertyEditorRegistrar" class="com.xiaoxin008.spring.processor.editor.AutoInitEditor.DatePropertyEditorRegister">
//        <property name="propertyEditor" ref="datePropertyEditor"></property>
//    </bean>
//
//    <bean id="datePropertyEditor" class="com.xiaoxin008.spring.processor.editor.AutoInitEditor.DatePropertyEditor">
