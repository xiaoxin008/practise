package com.xiaoxin008.spring.bean.factory;

import com.xiaoxin008.spring.bean.common.Apple;
...
//    xml配置文件
//    <bean id="shop" class="com.xiaoxin008.spring.bean.common.Shop" scope="prototype">
//        <property name="name" value="Full-Mart"></property>
//        <property name="apple" ref="appleFactory"></property>
//    </bean>
//
//    <bean id="appleFactory" class="com.xiaoxin008.spring.bean.factory.AppleFactory">
//
//    </bean>
