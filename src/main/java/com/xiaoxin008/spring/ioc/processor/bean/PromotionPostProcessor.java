package com.xiaoxin008.spring.ioc.processor.bean;
...
//        xml配置文件
//        <bean id="shopPromotion" class="com.xiaoxin008.spring.ioc.processor.bean.PromotionPostProcessor$ShopPromotion"></bean>
...
//        xml配置文件
//        <bean id="shopPromotion" class="com.xiaoxin008.spring.ioc.processor.bean.PromotionPostProcessor$ShopPromotion"></bean>
//        <bean id="promotionPostProcessor" class="com.xiaoxin008.spring.ioc.processor.bean.PromotionPostProcessor"></bean>
    }
}
